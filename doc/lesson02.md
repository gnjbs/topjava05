...
## Домашнее задание HW02
    ...
    - Сделать реализацию слоев приложения для функциональности "еда":
      ...
      - нельзя позволять модифицировать/смотреть чужую еду. Контроллеры смотрят наружу, запрос может прийти с любым id.
        Если еда чужая или отсутствует- бросать NotFoundException.
